...
<body>
    ...
    <div class="site-wrapper">
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/l1.png" alt=""> </a>
        ...
        <div class="page-wrapper">
            ...
            <?php
    if (isset($_POST['submit']) && $_POST['mod'] == "paypal") {
        ...
        echo '<input type="hidden" name="return" value="http://your-website.com/success.php">'; // Replace with your success page URL
        echo '<input type="hidden" name="cancel_return" value="http://your-website.com/cancel.php">'; // Replace with your cancel page URL
        echo '<input type="submit" name="submit" class="btn btn-success btn-block" value="Pay with PayPal">';
        echo '</form>';
    }
    ?>
